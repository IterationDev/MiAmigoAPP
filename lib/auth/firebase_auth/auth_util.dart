...
DocumentReference? get currentUserReference =>
    loggedIn ? UsersAuthRecord.collection.doc(currentUser!.uid) : null;

UsersAuthRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UsersAuthRecord.getDocument(UsersAuthRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
