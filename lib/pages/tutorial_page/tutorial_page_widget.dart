...
class _TutorialPageWidgetState extends State<TutorialPageWidget> {
  ...
  void initState() {
    ...
    _model.tutorialSearchTextController ??= TextEditingController();
    _model.tutorialSearchFocusNode ??= FocusNode();
  }
                ...
                Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      'obd7echj' /* Tu Tutor tiene algo que enseña... */,
                    ),
                      ...
                      Expanded(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              16.0, 10.0, 16.0, 10.0),
                          child: TextFormField(
                            controller: _model.tutorialSearchTextController,
                            focusNode: _model.tutorialSearchFocusNode,
                            autofocus: true,
                            obscureText: false,
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                                'nylpu3ek' /* Busca lo que quieras aprender.... */,
                              ),
                          ...
                          child: FlutterFlowChoiceChips(
                            options: [
                              ChipData(FFLocalizations.of(context).getText(
                                'qa88r9mp' /* Tareas Del Hogar */,
                              )),
                              ChipData(FFLocalizations.of(context).getText(
                                '3kd5m10t' /* Actividades Diarias */,
                              )),
                              ChipData(FFLocalizations.of(context).getText(
                                'j1y87ry5' /* Actividades Especificas */,
                              )),
                              ChipData(FFLocalizations.of(context).getText(
                                'jg6fv4pz' /* Recordatorios */,
                              )),
                              ChipData(FFLocalizations.of(context).getText(
                                'oojrhp1u' /* Otros */,
                              ))
                            ...
                            selectedChipStyle: ChipStyle(
                              backgroundColor:
                                  FlutterFlowTheme.of(context).common3,
                            ...
                            unselectedChipStyle: ChipStyle(
                              backgroundColor:
                                  FlutterFlowTheme.of(context).common13,
                              textStyle: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    font: GoogleFonts.roboto(
